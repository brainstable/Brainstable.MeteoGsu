...
{
    public partial class ChartTemperatureRain : UserControl
    {
        public ChartTemperatureRain()
        {
            InitializeComponent();
            InitializeChart();
        }
        ...
        public virtual void UpdateChart(int year, string plot, List<double?[]> listValues)
        {
            ...
            chartControl1.Title.Text = $"График температуры и осадков на {plot} ГСУ за {year} год";
